...
class DouyinSpider(scrapy.Spider):
    ...
    #采集地址
    url='https://www.iesdouyin.com/web/api/v2/challenge/aweme/?ch_id=1550712576368642&count=%d&cursor=%d&aid=1128&screen_limit=3&download_click_limit=0&_signature=aH.ejhAWNpVhM6SbAlvK5Wh.3p'%(size,size*page)
    ...
    def parse(self, response):
        ...
        if(data['status_code']==0):
            url='https://www.iesdouyin.com/web/api/v2/challenge/aweme/?ch_id=1550712576368642&count=%d&cursor=%d&aid=1128&screen_limit=3&download_click_limit=0&_signature=aH.ejhAWNpVhM6SbAlvK5Wh.3p'%(self.size,(self.size*self.page))
            ...
            if(self.page>=self.max_page):
                self.con.set('music', 'page',str(self.page))# 给music分组的page属性设置值
